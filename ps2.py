...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    '''
    #print('Let\'s play Hardcore Hangman! \(no hints allowed!')
    ...
    #                 print('Great job!: {}'.format(guessed_word))
    #             else:
    #                 if letter_guessed in 'aeiou':
    #                     num_of_guesses_left -= 2
    #                 else:
    #                     num_of_guesses_left -= 1  
    #                 print('Nope, try again!: {}'.format(guessed_word))
    #         else:
    #             if num_of_warnings_left > 0:
    #                 num_of_warnings_left -= 1
    #                 print('You\'ve already guessed that one. You now have {} warnings: {}'.format(num_of_warnings_left, guessed_word))
    #             else:
    #                 num_of_guesses_left -= 1
    #                 print('You\'ve already guessed that one. You now have no warnings left so you lose one guess: {}'.format(guessed_word))

    #     else:
    #         if num_of_warnings_left > 0:
    #             num_of_warnings_left -= 1
    #             print('Not a valid letter!. You have {} warnings left: {}'.format(num_of_warnings_left, guessed_word))
    #         else:
    #             num_of_guesses_left -= 1
    #             print('You\'ve already guessed that one. You have no warnings left so you lose one guess: {}'.format(guessed_word))
    ...
    #         print('Your total score is {}'.format(num_of_guesses_left * len(unique_letters_in_secret_word)))
    #         break
...
def hangman_with_hints(secret_word):
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    Follows the other limitations detailed in the problem write-up.
    '''
    print('Let\'s play Hangman with hints!!!!')
    print('for help enter *')
    print('the word is {} letters long'.format(len(secret_word)))
    ...
    while True:
        ...
        if letter_guessed.isalpha():
            if letter_guessed not in letters_guessed:   
                ...
                if letter_guessed in secret_word:
                    print('Excellent!: {}'.format(guessed_word))
                else:
                    if letter_guessed in 'aeiou':
                        num_of_guesses_left -= 2
                    else:
                        num_of_guesses_left -= 1  
                    print('Not Excellent!: {}'.format(guessed_word))
            else:
                if num_of_warnings_left > 0:
                    num_of_warnings_left -= 1
                    print('You\'ve already guessed that letter. You now have {} warnings: {}'.format(num_of_warnings_left, guessed_word))
                else:
                    num_of_guesses_left -= 1
                    print('You\'ve already guessed that letter. You now have no warnings left so you lose one guess: {}'.format(guessed_word))
        elif letter_guessed == '*':
